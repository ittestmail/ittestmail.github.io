...
if(session_status() == PHP_SESSION_ACTIVE){
    ...
    ?>
    <script async >start_countdown();</script>
    <?php
    }
?>
                            ...
                            <div class="canven-menu-warp">
                                <div class="canven-menu-iner">
                                    <ul>
                                        ...
                                        <li><br><br><br><button class="btn btn-link profile-link"><a data-toggle="modal" href="#myModal" class="ti-user"><br><?php echo $_SESSION['username']; ?></a></button></li>

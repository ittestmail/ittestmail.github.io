                            ...
                            <div class="canven-menu-warp">
                                <div class="canven-menu-iner">
                                    <ul>
                                        ...
                                        <li><a href="service.html">Onze Service</a></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="banner_text_iner">
                            <br>
                            <h1>NIEWE APP SCANNER VOOR ANDROID</h1>
                            <p>Niewe scan app</p>
                            <div class="banner_btn">
                                <a href="#section2" class="btn_1" >learn more <span><img src="img/icon/left.svg" alt=""></span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="banner_text_iner">
                            <br>
                            <h1>PROJECT X BEKIJK ALLE PRODUCTEN</h1>
                            <p>bekijk alle apps</p>
                            <div class="banner_btn">
                                <a href="#section2" class="btn_1" >learn more <span><img src="img/icon/left.svg" alt=""></span>
                                </a>
                            </div>
                            ...
                            <div class="row align-items-center mt_less_1177 single_service">
                                <div class="col-lg-5 col-md-6">
                                    <div class="service_text">
                                        ...
                                        <ul>
  <li>Klanten portaal (order invoer en overzicht, voorraad overzichten, raadplegen documenten)</li>
  <li>Android apps</li>
  <li>Control tower</li>
  <li>Facturen flow</li>
</ul>  
<a href="service.html" class="btn_1">lees meer <span><img
    ...
    <!-- blog part start-->
    <section class="blog_part" id="section2">
        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="single_project_text">
                                        ...
                                        <p>
Met JORR-CONNECT laten we de informatie die de klant opvoert in de applicatie aansluiten op de grotere platforms. Dat is nu al mogelijk met de volgende standaardkoppelingen</p>
                                    </div>
                                </div>
                            </div>
                        </div>
